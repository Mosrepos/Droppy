        ...
        Group {
            ...
            Section {
                ...
                if enableHUDReplacement {
                    ...
                    Toggle(isOn: $enableCompactHUDIconScaling) {
                        VStack(alignment: .leading, spacing: 2) {
                            Text("Compact HUD Icons")
                            Text("Use smaller sound/brightness symbols in HUD")
                                .font(.caption)
                                .foregroundStyle(.secondary)
                        }
                    }

                    Toggle(isOn: $enableCustomBatteryHUDIcons) {
                        VStack(alignment: .leading, spacing: 2) {
                            Text("Custom Battery Icons")
                            Text("Use imported battery image assets instead of default glyphs")
                                .font(.caption)
                                .foregroundStyle(.secondary)
                        }
                    }
