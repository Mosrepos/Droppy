...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    func applicationDidFinishLaunching(_ notification: Notification) {
        ...
        UserDefaults.standard.register(defaults: [
            ...
            AppPreferenceKey.enableMediaKeyFineStepOverride: PreferenceDefault.enableMediaKeyFineStepOverride,
            AppPreferenceKey.enableMediaKeyInterceptionDebugLogs: PreferenceDefault.enableMediaKeyInterceptionDebugLogs,
            AppPreferenceKey.showMediaPlayer: PreferenceDefault.showMediaPlayer,
            AppPreferenceKey.enableMediaQuickOpenShortcut: PreferenceDefault.enableMediaQuickOpenShortcut,
            AppPreferenceKey.enableOrderOutWhenInactive: PreferenceDefault.enableOrderOutWhenInactive,
