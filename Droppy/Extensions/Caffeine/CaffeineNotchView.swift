...
struct CaffeineNotchView: View {
    ...
    var body: some View {
        // ALIGNMENT STANDARD: Match TerminalNotchView's quickCommandView structure exactly
        // VStack with Spacer at bottom ensures content stays at top with proper padding
